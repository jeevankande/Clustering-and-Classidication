...
def principle_component_analysis(df_scaled):
...
def main():
    ...
    data_scaled = Data_loader()

    print("2. Reducing via PCA")
    pca_result, pca_2 = principle_component_analysis(data_scaled)
